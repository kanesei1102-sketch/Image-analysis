...
# 0. ページ設定
# ---------------------------------------------------------
st.set_page_config(page_title="Bio-Image Quantifier Pro (List View)", layout="wide")
...
st.caption("2026年最新版：解析・データ抽出専用 (List View Mode)")

# ★ここでタブを作成（バリデーションタブを復元）
    ...
    if uploaded_files:
        ...
        for i, file in enumerate(uploaded_files):
            ...
            if img_bgr is not None:
                ...
                # --- 結果表示 (修正: Expanderを廃止し、区切り線で一覧表示) ---
                st.divider()
